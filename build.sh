...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    GOOS=darwin GOARCH=amd64 CGO_ENABLED=1 go build -a -ldflags="-s -w" -o chronono_amd64
    GOOS=darwin GOARCH=arm64 CGO_ENABLED=1 go build -a -ldflags="-s -w" -o chronono_arm64
